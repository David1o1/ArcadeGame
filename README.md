...
### 3. Finished vers: 
#### Final version with player controls, computer paddle movement, scoring, win condition, and restart screen. I won first, and let bot win second if it wasn´t clear :))
